...
class AddSusToClassTest {
    ...
    fun addSusToClassTest() {
        ...
        appCompatEditText5.perform(replaceText("1b"), closeSoftKeyboard())
        ...
        val materialButton5 = onView(
            allOf(
                withId(R.id.button_add_student_to_class), withText("SuS hinzufügen"),
                childAtPosition(
                    allOf(
        ...
        val materialButton6 = onView(
            allOf(
                withId(R.id.btnAddSusToClass), withText("Speichern"),
                childAtPosition(
                    childAtPosition(
