...
class ClassViewDetailsExists {
    ...
    fun classViewDetails2() {
        ...
        val appCompatEditText = onView(
                allOf(withId(R.id.text_class_name),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()))
        appCompatEditText.perform(replaceText("1a"), closeSoftKeyboard())
        ...
        val viewGroup = onView(
                allOf(withParent(allOf(withId(R.id.nav_host_fragment),
